...
public class PapillonB {
	...
	public PapillonB(PVector l, DNAinsect dnainsect_, PApplet p){
		...
		maxspeed = PApplet.map(dnainsect.genes[0], 0, 1, (float)0.5, (float)0.7);
		lifeTime = PApplet.map(dnainsect.genes[0], 0, 1, 100, 200);
