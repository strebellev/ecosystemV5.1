...
public class VoleM {
	...
	public VoleM(PVector l, DNAvole dnavole_, PApplet p){
		parent = p;
		position = l.get();
		xoff = p.random(3200);
		yoff = p.random(3200);
		...
		health = PApplet.map(dnavole.genes[0], 0, 1, 50, 250);
		r = PApplet.map(dnavole.genes[0], 0, 1, 4, 8);
		//maxspeed = PApplet.map(dnasouris.genes[0], 0, 1, 1, 2);
		lifeTime = PApplet.map(dnavole.genes[0], 0, 1, 200, 300);
		maxLifeTime = PApplet.map(dnavole.genes[0], 0, 1, 200, 300);
		//water = PApplet.map(dnasouris.genes[1], 0, 1, 100, 200);
		food = PApplet.map(dnavole.genes[1], 0, 1, 100, 200);
		fieldOfView = PApplet.map(dnavole.genes[2], 0, 1, 200, 300);
		
		speed = PApplet.map(dnavole.genes[0], 0, 1, (float)0.7, 1);
		
		///for food 1000 = 1kg
		weight = PApplet.map(dnavole.genes[1], 0, 1, 400, 600);
		foodPerDay = 0;
		maxFoodPerDay = PApplet.map(dnavole.genes[1], 0, 1, 30, 60);
		...
		//////test anim/////
		animU[0] = p.loadImage("res/newAnimal/Vole/VoleU0.png");
		animU[1] = p.loadImage("res/newAnimal/Vole/VoleU1.png");
		animU[2] = p.loadImage("res/newAnimal/Vole/VoleU2.png");
		animU[3] = p.loadImage("res/newAnimal/Vole/VoleU3.png");
		
		animUR[0] = p.loadImage("res/newAnimal/Vole/VoleUR0.png");
		animUR[1] = p.loadImage("res/newAnimal/Vole/VoleUR1.png");
		animUR[2] = p.loadImage("res/newAnimal/Vole/VoleUR2.png");
		animUR[3] = p.loadImage("res/newAnimal/Vole/VoleUR3.png");
		
		animR[0] = p.loadImage("res/newAnimal/Vole/VoleR0.png");
		animR[1] = p.loadImage("res/newAnimal/Vole/VoleR1.png");
		animR[2] = p.loadImage("res/newAnimal/Vole/VoleR2.png");
		animR[3] = p.loadImage("res/newAnimal/Vole/VoleR3.png");
		
		animDR[0] = p.loadImage("res/newAnimal/Vole/VoleDR0.png");
		animDR[1] = p.loadImage("res/newAnimal/Vole/VoleDR1.png");
		animDR[2] = p.loadImage("res/newAnimal/Vole/VoleDR2.png");
		animDR[3] = p.loadImage("res/newAnimal/Vole/VoleDR3.png");
		
		animD[0] = p.loadImage("res/newAnimal/Vole/VoleD0.png");
		animD[1] = p.loadImage("res/newAnimal/Vole/VoleD1.png");
		animD[2] = p.loadImage("res/newAnimal/Vole/VoleD2.png");
		animD[3] = p.loadImage("res/newAnimal/Vole/VoleD3.png");
		
		animDL[0] = p.loadImage("res/newAnimal/Vole/VoleDL0.png");
		animDL[1] = p.loadImage("res/newAnimal/Vole/VoleDL1.png");
		animDL[2] = p.loadImage("res/newAnimal/Vole/VoleDL2.png");
		animDL[3] = p.loadImage("res/newAnimal/Vole/VoleDL3.png");
		
		animL[0] = p.loadImage("res/newAnimal/Vole/VoleL0.png");
		animL[1] = p.loadImage("res/newAnimal/Vole/VoleL1.png");
		animL[2] = p.loadImage("res/newAnimal/Vole/VoleL2.png");
		animL[3] = p.loadImage("res/newAnimal/Vole/VoleL3.png");
		
		animUL[0] = p.loadImage("res/newAnimal/Vole/VoleUL0.png");
		animUL[1] = p.loadImage("res/newAnimal/Vole/VoleUL1.png");
		animUL[2] = p.loadImage("res/newAnimal/Vole/VoleUL2.png");
		animUL[3] = p.loadImage("res/newAnimal/Vole/VoleUL3.png");
	...
	public ArrayList<PVector> getVoleM(){
		return volem;
	}
